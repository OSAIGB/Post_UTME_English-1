...
const CATEGORY_LABELS: Record<QuestionCategory, string> = {
  ...
  CHEMISTRY: 'Chemistry (Energy Changes & Reaction Rates)',
  BIOLOGY: 'Biology (Natural Habitats & Local Biomes)',
  GOVERNMENT: 'Government (Foreign Policy & Political Science)',
  ECONOMICS: 'Economics (Public Finance & Economic Development)',
